...
<head>
    ...
    <center><header style="font-size:25px;background-color: greenyellow;padding: 20px;margin-bottom: 5px;">Year Expenses Report<br>Year <?php echo date('Y', $mycur1); ?></header></center>
    ...
    background-color: #f3f3f6;
           ...
           <table border="1" width="100%" > 
             ...
             <tbody>
                <?php 
                    $cur = date("Y-m-d");
                      $sqlinventory = "SELECT * FROM expense_table  WHERE YEAR(`expense_date`)=YEAR( CURRENT_DATE )";
