...
<head>
    ...
    <center><header style="font-size:25px;background-color: greenyellow;padding: 20px;margin-bottom: 5px;">Monthy Expenses Report<br>Month of <?php echo date('F', $mycur2); ?></header></center>
             ...
             <tbody>
                <?php 
                    $cur = date("Y-m-d");
                      ...
                      $sqlinventory = "SELECT * FROM expense_table  WHERE MONTH(`expense_date`)='$test'";
                     ...
                     while ($row = mysqli_fetch_array($resultinventory)) {
                      ...
                      ?>
                        ...
                        <footer><?php
                            $totalsql = "SELECT SUM(expense_price) as totals FROM expense_table WHERE MONTH(`expense_date`)='$test'";
