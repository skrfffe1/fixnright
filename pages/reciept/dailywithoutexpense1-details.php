...
<head>
  ...
  <link href="/dist/output.css" rel="stylesheet">
	...
	<center><header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">Daily Income w/o Expense Reports<br><br>Chosen Date is  <?php echo date('F, jS, Y', $mycur2); ?></header></center>
