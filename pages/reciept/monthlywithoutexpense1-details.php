...
<head>
  ...
  <link href="/dist/output.css" rel="stylesheet">
	...
	<center><header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">Monthly Income w/o Expense Reports<br>Month of  <?php echo date('F , Y', $mycur2); ?></header></center>
                     ...
                     while ($row = mysqli_fetch_array($resultinventory)) {
                      ...
                      ?>
                        ...
                        <footer><?php
                            ...
                            $countsql = "SELECT count(*) as total FROM transaction_table WHERE transaction_sched ='$test';";
                         ...
                         ?><br>
                             <header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">
                                ...
                                Parts & Materials  = <?php echo number_format($totalpartsum,'2') ?>
                                   <br>
                                Income this Month of <?php echo date('F , Y', $mycur2); echo " = ", number_format($managetotal,'2') ?></header>
                         </footer>
