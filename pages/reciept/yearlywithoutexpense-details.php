...
<head>
    ...
    <center><header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">Yearly Income w/o Expense Reports<br>Year  <?php echo date('Y', $mycur); ?></header></center>
                         ...
                         ?><br>
                             <header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">
                                ...
                                Parts & Materials  = <?php echo number_format($totalpartsum,'2') ?>
                                   <br>Income this Year   <?php echo date('Y', $mycur);echo " = ",number_format($managetotal,'2') ?></header>
                         </footer>
