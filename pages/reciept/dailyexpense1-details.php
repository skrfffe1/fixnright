...
<head>
  ...
  <link href="/dist/output.css" rel="stylesheet">
    ...
    <center><header style="font-size:25px;background-color: greenyellow;padding: 20px;margin-bottom: 5px;">Daily Expenses Report<br>Today is  <?php echo date('F, jS, Y', $mycur2); ?></header></center>
                    ...
                    $cur = date("Y-m-d");
                     ...
                     while ($row = mysqli_fetch_array($resultinventory)) {
                      ...
                      ?>
                        ...
                        <footer><?php
                            $totalsql = "SELECT SUM(expense_price) as totals FROM expense_table WHERE expense_date = '$chosendate';";
