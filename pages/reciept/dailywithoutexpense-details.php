...
<head>
  ...
  <link href="/dist/output.css" rel="stylesheet">
	...
	<center><header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">Daily Income w/o Expense Reports<br>Today is  <?php echo date('F, jS, Y', $mycur); ?></header></center>
                         ...
                         ?><br>
                             <header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">
                                ...
                                Parts & Materials  = <?php echo number_format($totalpartsum,'2') ?>
                                   <br>
                                Income for Today   = <?php echo number_format($managetotal,'2') ?></header>
                         </footer>
