...
<head>
	...
	<center><header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">Yearly Income w/o Expense Reports<br>Year of  <?php echo date('Y', $mycur2); ?></header></center>
                      ...
                      ?>
                        ...
                        <footer><?php
                            ...
                            //haha
                             ...
                             $totalexpensesql = "SELECT SUM(expense_price) as totalexpense FROM expense_table WHERE MONTH(`expense_date`)='$test2'";
                         ...
                         ?><br>
                             <header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">
                                ...
                                Parts & Materials  = <?php echo number_format($totalpartsum,'2') ?>
                                   <br>
                                Income this Year of <?php echo date('Y', $mycur2); echo " = ", number_format($managetotal,'2') ?></header>
                         </footer>
