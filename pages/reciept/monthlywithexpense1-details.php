...
<head>
  ...
  <link href="/dist/output.css" rel="stylesheet">
	<title>Monthly Income  w/ Expense PDF</title>

	<center><header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">Monthly Income w/ Expense Reports<br>Month of  <?php echo date('F , Y', $mycur2); ?></header></center>
             ...
             <tbody>
                <?php 
                    $currentdate = date("Y-m-d");
                     ...
                     $sqlinventory = "SELECT * FROM expense_table WHERE MONTH(`expense_date`)='$test' AND YEAR(`expense_date`) = '$test2' ORDER BY expense_price ASC";
                     $resultinventory = mysqli_query($con, $sqlinventory) or die(mysqli_error($db));
                     while ($row = mysqli_fetch_array($resultinventory)) {
                         ...
                         ?><br>
                             <header style="font-size:25px;background-color: greenyellow;padding: 25px;margin-bottom: 10px;">
                                ...
                                Expenses  = <?php echo number_format($totalexpensesum,'2') ?>
                                   <br>Income this Month of  <?php echo date('F , Y', $mycur2);echo " = ",number_format($managetotal2,'2') ?></header>
                         </footer>
