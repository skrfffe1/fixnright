...
<head>
  ...
  <link href="/dist/output.css" rel="stylesheet">
    ...
    <center><header style="font-size:25px;background-color: greenyellow;padding: 20px;margin-bottom: 5px;">Daily Expenses Report<br>Today is  <?php echo date('F, jS, Y', $mycur1); ?></header></center>
