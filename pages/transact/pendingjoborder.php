...
$sqlresultinfos = $con->query($sqluserinfos);
  ...
  $update = $db->update('transacttable',$data,array('transid'=>$editId));
...
<body>
          ...
          <?php echo "Current Car ID : ", $pendingcarID;?> 
           <br>
           <?php echo "Current User ID : ", $pendinguserID;?>
            <br>
           <?php echo "Current Transaction ID : ", $tempid;?>
          </div>
          <br>
          <div class="card-header py-3">
            <h4>Information</h4>
          ...
          <div class="col-md-2 mb-3">
            ...
            <form action ="#" method="POST" id ="add_form">
              <div id="show_item">
                ...
                <?php 
              $sqlpendingorder = " SELECT  * FROM   transaction_table WHERE transaction_id ='$tempid'" ;
              $resultpendingorder = $con->query($sqlpendingorder);
             while($row = $resultpendingorder->fetch_assoc()) {
              echo ' <hr >
                <div class="row">
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-12 border-bottom-primary">
            ...
            <form  method="post" action="../client/process.php">
              ...
              <div  class="form-group row text-left font-weight-bold">
                ...
                <div class="col-sm-9">
                  ...
                  <input type="text" class="form-control" name="numofitem" id="numofitem"  value="<?php echo $pendingnumofitems;?>"  required>
                </div>
              </div>
               <hr>
 ...
 <!--
        ...
        <option disabled selected><?php echo $pendingpaymentype ?></option>
