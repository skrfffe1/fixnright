...
$sql3 = "SELECT * FROM cardata WHERE id ='$tempo'";
 $result3 = $con->query($sql3);

$sql100 = "SELECT * FROM product_inventory ORDER by p_product_code ASC";
$result100 = mysqli_query($con, $sql100) or die ("Bad SQL: $sql100");

$sup = "<select class='form-control' id='product_name[]' name='product_name[]'>
        <option disabled selected>Select Product</option>";
  while ($row = mysqli_fetch_assoc($result100)) {
    $sup .= "<option value='".$row['p_id']."'>".$row['p_name']."</option>";
  }
 ...
 <div class="row my-4">
      <div class="col-lg-10 mx-auto">
        <div class="card shadow">
          <div class="card-header"><a  href="transact-bill.php?editId=<?php echo $tempo ;?> type="button class="btn btn-primary bg-gradient-success float-right"> <i class="fas fa-flip-horizontal fa-fw fa-car"></i> Proceed </a>
            <h4>Materials and Labor</h4>
          </div>
          <div class="card-body p-4">
            ...
            <form action ="#" method="POST" id ="add_form">
                ...
                <div class="row">
                 ...
                 <!-- <div class="col-md-3 mb-3"> -->
                    <input type = "hidden" name="product_qty[]" class="form-control" value="<?php echo $tempo ?>" required>
                  <!-- </div> -->
  ...
  <script>
    $(document).ready(function(){
      ...
      $(".add_item_btn").click(function(e){
        e.preventDefault();
        $("#show_item").prepend(' <div class="row append_item"><div class="col-md-4 mb-3"><input type = "text" name="product_name[]" class="form-control" placeholder=" Materials" required></div><div class="col-md-3 mb-3"><input type = "number" name="product_price[]" class="form-control"  placeholder=" Item Price" required></div><!-- <div class="col-md-3 mb-3"> --><input type = "hidden" name="product_qty[]" class="form-control" value="<?php echo $tempo ?>" required> <!-- </div> --><div class="col-md-2 mb-3 d-grid"><button class="btn btn-danger remove_item_btn">Remove</button></div></div>');
      });
