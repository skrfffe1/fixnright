...
?>
            ...
            <div class="form-group row text-left mb-0 py-2">
             ...
             <!--       <tr>
                    ...
                    <tr>
                    -->
                      <td class="font-weight-bold">Total Cash : ₱  <a type="button" class="btn btn-primary bg-gradient-primary" href="transact-bill.php?editId=<?php echo $tempo ;?>"><i class="fas fa-fw fa-list-alt"></i> Details</a> </td>
