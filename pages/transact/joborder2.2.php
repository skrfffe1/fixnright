                ...
                <div class="row">
                 ...
                 <option>Services</option>
                     ...
                     <div class="col-md-1 mb-3">
                      <label style="font-weight: bold;">Rate</label>
                    <input type = "
                    " name="product_rate[]" class="form-control"  required>
                  </div>
...
<!--<body onload="multiply();">
<input type="number" name="one" id="one" value="0" onclick="multiply();">

<input type="number" name="two" value = "0" id="two" onclick="multiply();">
