...
foreach($_POST['product_name'] as $key => $value){
    ...
    $sql = 'INSERT INTO transaction_table(transact_category,name, rate, hour, chance, price, transaction_user_id, transaction_id,car_id_labor) VALUES (:transact_category, :name, :rate, :hour, :chance, :price, :transaction_user_id, :transaction_id, :car_id_labor)';
...
$sqltransaction= "SELECT * FROM transaction_table WHERE transaction_id ='$temporaryid'";
...
echo "<br>";
echo "Current User ID : ",$tempcarid;
echo "<br>";
echo "Current Car ID : ",$sum;
echo "<br>";
echo "Current Total: ",$totalsum;
echo "<br>";
echo "Current Num of Service : ",$numofservice;
echo "<br>";
echo "Current Transaction ID : ",$temporaryid;
