...
<?php
  ...
  $result = mysqli_query($con,"SELECT * from services WHERE service_jd = $temps;");
  ...
  <div class="container">
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <form name="frmUser" method="post" action="../process/process.php">
              ...
              <input type="hidden" name="service_jd" value="<?php echo $temps; ?>" />
              <div class="form-group row text-left  font-weight-bold">
                <div class="col-sm-3" style="padding-top: 5px;">
                Service Type:
                </div>
                <div class="col-sm-9">
                   <input type="text" name="service_category"  class="form-control" value="<?php echo $row['service_category']?>" required>
                </div>
              </div>
               ...
               <div class="form-group row text-left  font-weight-bold">
                ...
                <div class="col-sm-9">
                  <input type="text" name="service_name"  class="form-control" value="<?php echo $row['service_name']?>">
                </div>
              </div>
              <div class="form-group row text-left  font-weight-bold">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input type="text" name="service_price"  class="form-control" value="<?php echo $row['service_price']?>" required>
                </div>
              </div>
              </div> 
               
              <hr>
                <button type="submit" name="updateservice" value="submit"  class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Update</button> 
              </form>  
          </div>
  </div>
  </div>
