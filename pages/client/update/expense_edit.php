  ...
  <div class="container">
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Edit Expenses</h4>
            ...
            <form name="frmUser" method="post" action="../process/process.php">
              ...
              <hr>
                <button type="submit" name="updateexpenses" value="submit"  class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Update</button> 
              </form>  
          </div>
  </div>
  </div>
