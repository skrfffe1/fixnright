...
<body>
  ...
  <div class="container">
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            </div><a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="../supplier.php "> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
            <div class="card-body">
            ...
            <form name="frmUser" method="post" action="../process/process.php">
              ...
              <div class="form-group row text-left  font-weight-bold">
               ...
               <div class="form-group row text-left  font-weight-bold">
                ...
                <div class="col-sm-9">
                  <input readonly type="text" name="s_province"  class="form-control" value="<?php echo $row['s_province']?>" required>
                </div>
              </div>
              <div class="form-group row text-left  font-weight-bold">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input readonly type="text" name="s_city"  class="form-control" value="<?php echo $row['s_city']?>" required>
                </div>
              </div> 
               <div class="form-group row text-left  font-weight-bold">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <hr>
                <button type="submit" name="updatesupplier" value="submit"  class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Update</button> 
              </form>  
          </div>
  </div>
  </div>
