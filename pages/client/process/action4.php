...
foreach($_POST['itemname'] as $key => $value){
    ...
    $sql1 = 'INSERT INTO parts_table(item_category,item_name, item_price, item_amount, item_total, item_user_id, item_transaction_id,item_car_id,item_transaction_sched) VALUES (:item_category, :item_name, :item_price, :item_amount, :item_total, :item_user_id, :item_transaction_id, :item_car_id, :item_transaction_sched)';
