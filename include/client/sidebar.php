                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../client/supplier.php">Supplier</a>
                         <a class="collapse-item" href="../client/inventory.php">Inventory</a>
       ...
       <li class="nav-item">
                ...
                <div id="collapseUtilitiess" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="dailyreport.php">Daily Reports</a>
                        <a class="collapse-item" href="monthlyreport.php">Monthly Reports</a>
                        <a class="collapse-item" href="yearlyreport.php">Yearly Reports</a>
                    </div>
                </div>
            </li>
<li class="nav-item">
